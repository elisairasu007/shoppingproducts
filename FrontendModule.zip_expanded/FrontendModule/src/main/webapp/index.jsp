...
<body>
<div class="container">
<img src="<c:url value='/resources/images/e-commerce.jpg'></c:url>" height="200px" width="1135px">
<nav class="navbar navbar-inverse">
<div class="collapse navbar-collapse" id="navbardemo">
<ul class="nav navbar-nav">
<li><a><img src="<c:url value='/resources/images/shopping.png'></c:url>" height="30px" width="70px"></a></li>
